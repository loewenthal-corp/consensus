...
func (_u *SettingUpdate) SetTenantKey(v string) *SettingUpdate {
	_u.mutation.SetTenantKey(v)
	return _u
}

// SetNillableTenantKey sets the "tenant_key" field if the given value is not nil.
func (_u *SettingUpdate) SetNillableTenantKey(v *string) *SettingUpdate {
	if v != nil {
		_u.SetTenantKey(*v)
	}
	return _u
...
func (_u *SettingUpdate) SetValue(v map[string]string) *SettingUpdate {
...
func (_u *SettingUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ValueCleared() {
		_spec.ClearField(setting.FieldValue, field.TypeJSON)
	}
...
// SetTenantKey sets the "tenant_key" field.
func (_u *SettingUpdateOne) SetTenantKey(v string) *SettingUpdateOne {
	_u.mutation.SetTenantKey(v)
	return _u
}

// SetNillableTenantKey sets the "tenant_key" field if the given value is not nil.
func (_u *SettingUpdateOne) SetNillableTenantKey(v *string) *SettingUpdateOne {
	if v != nil {
		_u.SetTenantKey(*v)
	}
	return _u
...
// SetValue sets the "value" field.
func (_u *SettingUpdateOne) SetValue(v map[string]string) *SettingUpdateOne {
	_u.mutation.SetValue(v)
	return _u
}
...
func (_u *SettingUpdateOne) sqlSave(ctx context.Context) (_node *Setting, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`postgres: missing "Setting.id" for update`)}
	}
