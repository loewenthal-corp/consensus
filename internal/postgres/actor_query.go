...
func (_q *ActorQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ActorQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ActorQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ActorQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ActorQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *ActorQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ActorQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(actor.Table, actor.Columns, sqlgraph.NewFieldSpec(actor.FieldID, field.TypeUUID))
	_spec.From = _q.sql
