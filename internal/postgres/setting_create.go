...
func (_c *SettingCreate) SetTenantKey(v string) *SettingCreate {
	_c.mutation.SetTenantKey(v)
	return _c
}

// SetNillableTenantKey sets the "tenant_key" field if the given value is not nil.
func (_c *SettingCreate) SetNillableTenantKey(v *string) *SettingCreate {
	if v != nil {
		_c.SetTenantKey(*v)
	}
	return _c
...
func (_c *SettingCreate) SetValue(v map[string]string) *SettingCreate {
...
func (_c *SettingCreate) check() error {
	if _, ok := _c.mutation.TenantKey(); !ok {
		return &ValidationError{Name: "tenant_key", err: errors.New(`postgres: missing required field "Setting.tenant_key"`)}
	}
	if v, ok := _c.mutation.TenantKey(); ok {
		if err := setting.TenantKeyValidator(v); err != nil {
			return &ValidationError{Name: "tenant_key", err: fmt.Errorf(`postgres: validator failed for field "Setting.tenant_key": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Key(); !ok {
		return &ValidationError{Name: "key", err: errors.New(`postgres: missing required field "Setting.key"`)}
	}
	if v, ok := _c.mutation.Key(); ok {
		if err := setting.KeyValidator(v); err != nil {
			return &ValidationError{Name: "key", err: fmt.Errorf(`postgres: validator failed for field "Setting.key": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`postgres: missing required field "Setting.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`postgres: missing required field "Setting.updated_at"`)}
	}
	return nil
}
...
func (_c *SettingCreate) createSpec() (*Setting, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TenantKey(); ok {
		_spec.SetField(setting.FieldTenantKey, field.TypeString, value)
...
// SetTenantKey sets the "tenant_key" field.
func (u *SettingUpsert) SetTenantKey(v string) *SettingUpsert {
	u.Set(setting.FieldTenantKey, v)
	return u
}

// UpdateTenantKey sets the "tenant_key" field to the value that was provided on create.
func (u *SettingUpsert) UpdateTenantKey() *SettingUpsert {
	u.SetExcluded(setting.FieldTenantKey)
	return u
}
...
// SetValue sets the "value" field.
func (u *SettingUpsert) SetValue(v map[string]string) *SettingUpsert {
...
// SetTenantKey sets the "tenant_key" field.
func (u *SettingUpsertOne) SetTenantKey(v string) *SettingUpsertOne {
...
// UpdateTenantKey sets the "tenant_key" field to the value that was provided on create.
func (u *SettingUpsertOne) UpdateTenantKey() *SettingUpsertOne {
	return u.Update(func(s *SettingUpsert) {
		s.UpdateTenantKey()
	})
}
...
// SetValue sets the "value" field.
func (u *SettingUpsertOne) SetValue(v map[string]string) *SettingUpsertOne {
	return u.Update(func(s *SettingUpsert) {
		s.SetValue(v)
	})
}
...
func (u *SettingUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("postgres: missing options for SettingCreate.OnConflict")
	}
...
func (u *SettingUpsertOne) ID(ctx context.Context) (id uuid.UUID, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		...
		return id, errors.New("postgres: SettingUpsertOne.ID is not supported by MySQL driver. Use SettingUpsertOne.Exec instead")
	}
...
// SetTenantKey sets the "tenant_key" field.
func (u *SettingUpsertBulk) SetTenantKey(v string) *SettingUpsertBulk {
	return u.Update(func(s *SettingUpsert) {
		s.SetTenantKey(v)
	})
}
...
// UpdateTenantKey sets the "tenant_key" field to the value that was provided on create.
func (u *SettingUpsertBulk) UpdateTenantKey() *SettingUpsertBulk {
	return u.Update(func(s *SettingUpsert) {
		s.UpdateTenantKey()
	})
}
...
// SetValue sets the "value" field.
func (u *SettingUpsertBulk) SetValue(v map[string]string) *SettingUpsertBulk {
	return u.Update(func(s *SettingUpsert) {
		s.SetValue(v)
	})
}
...
func (u *SettingUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("postgres: OnConflict was set for builder %d. Set it on the SettingCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("postgres: missing options for SettingCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
